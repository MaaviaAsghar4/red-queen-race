    ...
    <div class="wrapper">
      ...
      <div class="earth">
        <div id="red-queen_and_alice">
          <img id="red-queen_and_alice_sprite" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/sprite_running-alice-queen_small.png" srcset="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/sprite_running-alice-queen.png 2x" ref={aliceandqueen} alt="Alice and the Red Queen running to stay in place." />
        </div>
      </div>

      <div class="scenery" id="foreground1" ref={foreground1}>
